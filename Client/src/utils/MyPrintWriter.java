...
public class MyPrintWriter extends Writer {
    ...
    /**
     * Creates a new MyPrintWriter, without automatic line flushing.
     *
    ...
    /**
     * Creates a new MyPrintWriter, without automatic line flushing, from an
    ...
    /**
     * Creates a new MyPrintWriter from an existing OutputStream.  This
     ...
     * @since 10
     */
    public MyPrintWriter(OutputStream out, boolean autoFlush, Charset charset) {
    ...
    /**
     * Creates a new MyPrintWriter, without automatic line flushing, with the
    ...
    /* Private constructor */
    private MyPrintWriter(Charset charset, File file)
            throws FileNotFoundException
    {
     ...
     * @since  1.5
     */
    public MyPrintWriter(String fileName, String csn)
     ...
     * @since  10
     */
    public MyPrintWriter(String fileName, Charset charset) throws IOException {
     ...
     * @since  1.5
     */
    public MyPrintWriter(File file, String csn)
            throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     * @since  10
     */
    public MyPrintWriter(File file, Charset charset) throws IOException {
    ...
    public boolean checkError() {
        ...
        if (out instanceof MyPrintWriter pw) {
     ...
     * @since  1.5
     */
    public MyPrintWriter printf(String format, Object ... args) {
     ...
     * @since  1.5
     */
    public MyPrintWriter printf(Locale l, String format, Object ... args) {
     ...
     * @since  1.5
     */
    public MyPrintWriter format(String format, Object ... args) {
        try {
            synchronized (lock) {
                ensureOpen();
                if ((formatter == null)
     ...
     * @since  1.5
     */
    public MyPrintWriter format(Locale l, String format, Object ... args) {
        try {
            synchronized (lock) {
                ensureOpen();
     ...
     * @since  1.5
     */
    public MyPrintWriter append(CharSequence csq) {
     ...
     * @since  1.5
     */
    public MyPrintWriter append(CharSequence csq, int start, int end) {
     ...
     * @since 1.5
     */
    public MyPrintWriter append(char c) {
        write(c);
        return this;
    }
}
